...
def build_fact_library(profile: dict, answer_library: dict | None = None) -> list[CandidateFact]:
    ...
    facts = [
        ...
        _fact("state", _value(contact, "state"), FactClass.REUSABLE, "candidate_profile"),
        _fact("postcode", _value(contact, "postcode"), FactClass.REUSABLE, "candidate_profile"),
        _fact("country", _value(contact, "country"), FactClass.REUSABLE, "candidate_profile"),
