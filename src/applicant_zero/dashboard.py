...
</style></head><body><main><h1>Applicant Zero</h1><p class='subtitle'>Local job review queue. Opening a link does not submit an application. · <a href='/answers'>Application answers</a> · <a href='/daily-digest'>Daily priorities</a></p>{insights}
